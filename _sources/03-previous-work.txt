...
The in depth analysis includes a description of the `quality controls`_ and is
modeled roughly around the `quality systems regulations`_ with a side by side
...
A second, `operations logs`_ also helps document specific and insightful
...
.. _`quality systems regulations`: http://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfcfr/CFRSearch.cfm?CFRPart=820
.. _`quality controls`: http://process-controls.readthedocs.org/en/latest/controls/index.html
.. _`operations logs`: http://process-controls.readthedocs.org/en/latest/operations/index.html
